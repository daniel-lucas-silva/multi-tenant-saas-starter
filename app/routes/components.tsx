            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-3">
                  <Avatarish name="Carlos Silva" />
                  <Avatarish name="Mariana Souza" online />
                  <Avatar size="default" />
                  <div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input placeholder="email@invalido" defaultValue="teste@" className="border-destructive focus-visible:ring-destructive" />
                  <p className="text-[11px] text-destructive">Por favor insira um email válido</p>
                </div>
            ...
            <Card>
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <SectionTitle>Card de Demonstração Mobile</SectionTitle>
                  <button
                    type="button"
                    onClick={toggleLike}
              ...
              <CardContent className="space-y-2">
                ...
                <div className="flex flex-wrap gap-1.5 pt-1">
                  ...
                  <Badge variant="outline">Zero Delay</Badge>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
